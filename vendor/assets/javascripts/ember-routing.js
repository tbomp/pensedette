...
//     get(this, 'states').forEach(function(state) {
//       if (state.isRouteState) {
//         var route = get(state, 'route');
//         if (Ember.none(route)) {
//           throw "A RouteState muste have a route";
//         }
//         this.registerRoute(route, get(state, 'name'));
//       }
//     }, this);
//   },
...
//     if (!routes) {
//       routes = Ember.RoutesManager.create();
//       set(this, 'routes', routes);
//     }
//     routes.add(route, this, function(params) {
//       set(this, 'routeContext', params);
//       this.goToState(name);
//     });
//   }
// });

// Ember.RouteStateSupport = Ember.Mixin.extend({
//   isRouteState: true,
//   route: ''
// });
